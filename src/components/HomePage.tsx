    ...
    <div className="w-full min-h-screen bg-[#FFF8F0] pb-40 relative font-sans">
      ...
      <nav className="w-full bg-white/90 backdrop-blur-md sticky top-0 z-[200] border-b border-orange-100 px-4 md:px-8 py-4 flex justify-between items-center shadow-sm">
        <div className="flex items-center gap-2">
            ...
            <span className="font-black text-[#4A2C2A] uppercase italic tracking-tighter text-xl leading-none">OnePaw</span>
        </div>
        ...
        <div className="bg-white/60 p-8 md:p-10 rounded-[50px] border border-orange-200 shadow-xl backdrop-blur-sm order-3">
          ...
          <div className="flex flex-col gap-6">
             ...
             <div className="grid grid-cols-2 gap-x-4 gap-y-3 text-[10px] md:text-[11px] font-black uppercase text-[#4A2C2A]/80 italic">
                <span className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-orange-500"></div> 1. Rehaan</span>
                <span className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-orange-400"></div> 2. Manqoosh</span>
                <span className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-orange-500"></div> 3. Tarooba</span>
                <span className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-orange-400"></div> 4. Fariya</span>
                <span className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-orange-500"></div> 5. Zikra</span>
                <span className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-orange-400"></div> 6. Yameen</span>
             </div>
          </div>
        </div>
      </section>

      {/* EMERGENCY DIRECTORY - FIXED: ALL DATA NOW VISIBLE */}
      <section className="w-full max-w-7xl mx-auto px-4 md:px-6 py-16 border-t border-orange-200/30">
          <div className="flex flex-col items-center mb-16 text-center">
            ...
            <p className="text-slate-500 font-bold uppercase text-[10px] tracking-[0.4em]">Official J&K Animal Husbandry Department</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
              <a href="tel:1962" className="bg-slate-900 p-10 rounded-[50px] text-white flex items-center justify-between hover:bg-black transition-all group shadow-2xl">
                  <div className="flex items-center gap-8"><div className="w-20 h-20 bg-red-600 rounded-[35px] flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform"><Phone size={36} fill="white"/></div><div><h4 className="text-4xl font-black italic tracking-tighter">1962</h4><p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Animal Ambulance (Toll Free)</p></div></div>
                  <div className="bg-white/10 px-8 py-3 rounded-2xl font-black text-xs uppercase">Dial</div>
              </a>
...
const ContactCard = ({ district, name, phone }: any) => (
    <div className="bg-slate-50 p-5 rounded-[28px] border border-slate-100 flex items-center justify-between hover:bg-white hover:shadow-xl hover:border-orange-200 transition-all group active:scale-95">
        <div className="text-left">
            <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">{district}</p>
            <h5 className="font-bold text-slate-800 text-sm leading-tight">{name}</h5>
        </div>
        <a href={`tel:${phone}`} className="p-3 bg-white border border-slate-100 rounded-2xl text-slate-400 group-hover:bg-green-600 group-hover:text-white transition-all shadow-sm">
